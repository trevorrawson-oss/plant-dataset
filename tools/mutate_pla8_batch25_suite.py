#!/usr/bin/env python3
"""mutate_pla8_batch25_suite -- mutation harness for the PLA-8 batch 25 promote suite.
...
Usage:
    mutate_pla8_batch25_suite.py             # all families
    mutate_pla8_batch25_suite.py --family X  # one family
    mutate_pla8_batch25_suite.py --list
"""
import argparse
import os
import shutil
...
PROMOTE = "promote_pla8_batch25.py"
SUITE = "test_promote_pla8_batch25.py"
...
def build_scratch():
    ...
    tmp = tempfile.mkdtemp(prefix="mut_b25_")
